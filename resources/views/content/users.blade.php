                    ...
                    <tbody>
                        @foreach($user as $users)
                            <tr>
                                ...
                                @if($users->ProfileSetup != NULL)
                                    <td>{{ $users->ProfileSetup->gender }}</td>
                                @else
                                    <td class="text-danger">NO GENDER</td>
                                @endif

                                @if($users->ProfileSetup != NULL)
                                    <td><img src="{{asset($users->ProfileSetup->image)}}" alt="Avatar" height="26" width="26" /></td>
                                @else
